<template>
  <div class="shop-card group">
    <div class="inner-box h-[420px] bg-white rounded-xl border border-gray-100 overflow-hidden transition-all duration-500 hover:-translate-y-1 hover:shadow-lg hover:shadow-[var(--theme-color)]/8 hover:border-[var(--theme-color)]/20 flex flex-col">
      ...
      <div class="lower-content p-3 flex flex-col flex-1 justify-between min-h-0">
        <div>
